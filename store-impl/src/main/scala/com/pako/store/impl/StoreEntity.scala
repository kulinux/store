...
/**
  * This is an event sourced entity. It has a state, [[StoreState]], which
  ...
  */
class StoreEntity extends PersistentEntity {

  override type Command = StoreCommand[_]
  override type Event = StoreEvent
  override type State = StoreState

  /**
    * The initial state. This is used if there is no snapshotted state to be found.
    */
  override def initialState: StoreState = StoreState("Hello", LocalDateTime.now.toString)
  ...
  override def behavior: Behavior = {
    case StoreState(message, _) => Actions().onCommand[UseGreetingMessage, Done] {
      ...
      case (GreetingMessageChanged(newMessage), state) =>
        ...
        // the event.
        StoreState(newMessage, LocalDateTime.now().toString)
...
/**
  ...
  */
case class StoreState(message: String, timestamp: String)
...
object StoreState {
  /**
    ...
    */
  implicit val format: Format[StoreState] = Json.format
}

/**
  * This interface defines all the events that the StoreEntity supports.
  */
sealed trait StoreEvent extends AggregateEvent[StoreEvent] {
  def aggregateTag = StoreEvent.Tag
}

object StoreEvent {
  val Tag = AggregateEventTag[StoreEvent]
}

/**
  * An event that represents a change in greeting message.
  */
case class GreetingMessageChanged(message: String) extends StoreEvent
...
/**
  ...
  */
sealed trait StoreCommand[R] extends ReplyType[R]
...
/**
  ...
  */
case class UseGreetingMessage(message: String) extends StoreCommand[Done]
...
/**
  ...
  * person.
  */
case class Hello(name: String) extends StoreCommand[String]
